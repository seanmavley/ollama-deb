...
ollama - program to do something

# SYNOPSIS

**ollama** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ollama** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ollama** and **bar** commands.
...
:   The system-wide configuration file to control the behaviour of
    ollama. See **foo.conf**(5) for further details.
...
**ollama** provides some return codes, that can be used in scripts:
